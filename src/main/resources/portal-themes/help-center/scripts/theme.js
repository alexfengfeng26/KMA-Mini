document.documentElement.dataset.themePreset = 'help-center'
...
const helpInput = document.querySelector('#help-search')
const helpSubmit = document.querySelector('#help-search-submit')
const helpResults = document.querySelector('#help-search-results')

if (helpInput && helpSubmit && helpResults) {
  const showMessage = (text) => {
    helpResults.hidden = false
    helpResults.replaceChildren()
    const message = document.createElement('p')
    message.className = 'search-empty'
    message.textContent = text
    helpResults.append(message)
  }
  ...
  helpSubmit.addEventListener('click', run)
